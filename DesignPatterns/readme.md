...
| **行为** | [责任链模式](chain.md)、[策略模式](strategy.md)、[模板方法模式](template.md)、[命令模式]、[解释器模式]、[观察者模式]、[访问者模式]、[中介者模式]、[访问者模式]、[迭代器模式](iterator.md) |
| **结构** | [装饰模式](decorator.md)、[适配器模式]、[组合模式]、[代理模式]、[桥梁模式](bridge.md)、[门面模式] |
